...
function useQueryTable(
    ...
    useMemo(() => {
        ...
        form.addEffects('useTable.page', () => {
            ...
            onFieldInputValueChange('pagination.*(current,pageSize)', (f) => {
            ...
            if (options?.queryRequest) {
                ...
                let result = await axios({
                    ...
                    data: {
                        ...form.values.filter,
                        pageIndex:
                            (form.values.pagination.current - 1) *
                            form.values.pagination.pageSize,
                        pageSize: form.values.pagination.pageSize,
                    },
                });
                ...
                batch(() => {
                    (form.values.list = newResult.data.data),
                        (form.values.pagination.total = newResult.data.count);
                });
            }
        },
        {
